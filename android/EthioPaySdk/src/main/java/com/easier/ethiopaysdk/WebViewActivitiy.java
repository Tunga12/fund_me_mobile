...
public class WebViewActivitiy extends Activity {
    ...
    private void initData() {
        ...
        NetWorkManager.getInstance().getRequest().toTradeWebPay(request).subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<TradeWebPayResponse>() {
                    @Override
                    ...
                    public void onNext(TradeWebPayResponse tradeWebPayResponse) {
                        Log.d(TAG, "toTradeSDKPay success code " + tradeWebPayResponse.getCode() + ", message "
                                + tradeWebPayResponse.getMsg());
                        if ("200".equals(tradeWebPayResponse.getCode())) {
                            ...
                            Toast.makeText(WebViewActivitiy.this, tradeWebPayResponse.getMsg(), Toast.LENGTH_LONG)
                                    .show();
                        }
                    }
